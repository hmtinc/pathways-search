  ...
  render() {
    return(
      <List>
        ...
        <ListItem component='div' className='flex-column'>
          <Typography type='subheading' className='menuSubheading'>Layouts</Typography>
        ...
        <ListItem component='div' className='flex-column'>
          <Typography type='subheading' className='menuSubheading'>Expand and collapse</Typography>
          <Typography component='div'>
        ...
        <ListItem component='div' className='flex-column'>
          <Typography type='subheading' className='menuSubheading'>Nearest neighbours</Typography>
          <Typography component='div'>
        ...
        <Typography type='headline'>Symbols</Typography>
        <ListItem component='div' className='flex-column'>
          <Typography type='subheading' className='menuSubheading'>Systems Biology Graphic Notation (SBGN)</Typography>
          <Typography component='div'>
        ...
        <ListItem component='div' className='flex-column'>
          <Typography type='subheading' className='menuSubheading'>Example walkthough</Typography>
          <Typography component='div'>
        ...
        <ListItem component='div' className='flex-column'>
          <Typography type='subheading' className='menuSubheading'>Quick reference: SBGN-PD Glyphs</Typography>
          <Typography component='div'>
